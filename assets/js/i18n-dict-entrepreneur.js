...
Object.assign(window.BEQI_I18N_DICT = window.BEQI_I18N_DICT || {}, {
  ...
  'entrepreneur.portal.projectIntro': {
    en: 'The self-assessment system is designed to help calculate your Biophilic Environmental Quality Index (BEQI Score).<br>It converts physical data from satellite imagery and the photos you upload — following the 14 Patterns of Biophilic Design framework — into an accurate assessment result.<br>Simply enter your information truthfully, and you can use the results to strengthen your competitive edge and attract environmentally conscious travelers.<br>Join us in raising the environmental quality standard for your property, in line with sustainable coastal tourism principles, and grow your business in balance with nature.',
    th: 'ระบบประเมินสถานประกอบการด้วยตนเองถูกออกแบบมาเพื่อช่วยคำนวณคะแนนดัชนีคุณภาพสภาพแวดล้อมเชิงไบโอฟิลิก (BEQI Score)<br>โดยระบบจะแปลงข้อมูลเชิงกายภาพจากภาพถ่ายดาวเทียมและภาพถ่ายที่ท่านอัปโหลดตามกรอบแนวคิด 14 Patterns of Biophilic Design ออกมาเป็นผลการประเมินอย่างแม่นยำ<br>เพียงกรอกข้อมูลตามความเป็นจริง ท่านก็สามารถนำผลที่ได้ไปวิเคราะห์ต่อยอดเพื่อเพิ่มศักยภาพการแข่งขันและดึงดูดกลุ่มนักท่องเที่ยวที่ใส่ใจสิ่งแวดล้อม<br>มาร่วมกันยกระดับมาตรฐานคุณภาพสภาพแวดล้อมใหม่ให้สถานประกอบการของท่าน เพื่อให้สอดคล้องกับหลักการท่องเที่ยวยั่งยืนในพื้นที่ชายฝั่งทะเลและสร้างการเติบโตทางธุรกิจควบคู่ไปกับธรรมชาติอย่างสมดุล'
  },
